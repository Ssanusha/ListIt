...
class ListItemsControllerTest < ActionController::TestCase
  ...
  test "should create list_item" do
    assert_difference('ListItem.count') do
      post :create, list_item: { name: @list_item.name, quantity: @list_item.quantity, stores_id: @list_item.stores_id }
    end
  ...
  test "should update list_item" do
    put :update, id: @list_item, list_item: { name: @list_item.name, quantity: @list_item.quantity, stores_id: @list_item.stores_id }
    assert_redirected_to list_item_path(assigns(:list_item))
  end
