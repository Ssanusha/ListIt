...
class ItemHistoriesControllerTest < ActionController::TestCase
  ...
  test "should create item_history" do
    assert_difference('ItemHistory.count') do
      post :create, item_history: { item_id: @item_history.item_id, item_name: @item_history.item_name, item_quantity: @item_history.item_quantity, stores_id: @item_history.stores_id }
    end
  ...
  test "should update item_history" do
    put :update, id: @item_history, item_history: { item_id: @item_history.item_id, item_name: @item_history.item_name, item_quantity: @item_history.item_quantity, stores_id: @item_history.stores_id }
    assert_redirected_to item_history_path(assigns(:item_history))
  end
